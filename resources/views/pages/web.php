...
Route::any('editlevelname',function(Request $request){
    ...
    return view('editlevels',compact('levels'))->middleware('auth:admin');
});
...
Route::any('pems/deletequestion/{id}/{examcode}',function(Request $request,$id,$examcode){
   ...
   if($question->id != 0) {
       $question->delete();
       return redirect()->back()->with('questions',$questions)->with(['success'=> '<br><br><br><br><br><br><br><br><br><Successfully deleted!!']);
   }
return "error".$id;
...
elseif(($correct_option == 'A')&&($select_option == 'B')){
        DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'B'],['option_B'=> $option_A],['option_A'=> $option_B]);  
}elseif(($correct_option == 'A')&&($select_option == 'C')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'C'],['option_A'=> $option_C],['option_C'=> $option_A]);  
}elseif(($correct_option == 'A')&&($select_option == 'D')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'D'],['option_D'=> $option_A],['option_A'=> $option_D]); 
} 
elseif(($correct_option == 'B')&&($select_option == 'A')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'A'],['option_B'=> $option_A],['option_A'=> $option_B]);  
 }
elseif(($correct_option == 'B')&&($select_option == 'C')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'C'],['option_B'=> $option_C],['option_B'=> $option_C]);  
 } 
elseif(($correct_option == 'B')&&($select_option == 'D')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'D'],['option_B'=> $option_D],['option_D'=> $option_B]);  
  } 
elseif(($correct_option == 'C')&&($select_option == 'A')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'A'],['option_C'=> $option_A],['option_A'=> $option_C]);
} 
elseif(($correct_option == 'C')&&($select_option == 'B')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'B'],['option_C'=> $option_B],['option_B'=> $option_C]);  
 } 
elseif(($correct_option == 'C')&&($select_option == 'D')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'D'],['option_C'=> $option_D],['option_D'=> $option_C]);  
 }  
elseif(($correct_option == 'D')&&($select_option == 'A')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'A'],['option_D'=> $option_A],['option_A'=> $option_D]);  
 }   
elseif(($correct_option == 'D')&&($select_option == 'B')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'B'],['option_D'=> $option_B],['option_B'=> $option_D]);  
}  
elseif(($correct_option == 'D')&&($select_option == 'C')){
    DB::table('exam_question')->where('id',$id)->update(['correct_option'=> 'C'],['option_D'=> $option_C],['option_C'=> $option_D]);  
} 
