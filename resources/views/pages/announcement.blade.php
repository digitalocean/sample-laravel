...
font-weight: bold;">Announcement </a>
</div>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h3>Sudanese Association of Certified Accountants ( SACA)</h3>
          <p style="background-image:'graduate.jpg';">NBC Nazlawi Business College Sudan  offers two separate programs i.e. Certified Project Accountants ACPA , and Certified Corporate Executive Accountants ACCEA . The qualified members of Sudanese Association of Certified Accountants (SACA) are entitled to get full membership of ACCEA (Association of Certified Corporate Accountants).
In addition to the above, NBC ,  sudan grants exemption in 09 papers out of 12 papers of its CPA program (Certified Project Accountant) to the qualified members of Sudanese Association of Certified Accountants ( SACA) members are also entitled to claim Graduate Accounting Technician (GAT Professional Certificate A) as well as Advanced Accounting Technician (Adv. Professional Certificate A) of both the above programs.
Web: Https://Acpaglobal.net.</p>
<p>
<img src="{{asset('/public/graduate.jpg')}}" width="724px" alt="">
