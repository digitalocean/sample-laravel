...
<div class="row justify-content-center">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="panel-heading">{{ __('Exam Login ') }}</div>

            <div class="card-body">
                <form method="POST" action="https://exam.acpaglobal.net/login">
                    @csrf
                  
<div class="row">
	<div class="col-lg-8">
			<div class="panel panel-primary">
				<div class="panel-heading">Exam Sign In</div>
	...
	<table>
            ...
            <th valign="middle" style="width:280px;"> <label for="student_id" class="col-md-6 col-form-label text-md-right">{{ __('Membership ID') }}</label></th>
