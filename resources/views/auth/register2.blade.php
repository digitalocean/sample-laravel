...
<h2>Register</h2>
	...
	<div class="col-lg-8">
		<div class="panel panel-default">
			...
			<div class="panel-body">
                <form action="/postregister2" method="POST" role="search">
                    @csrf
 ...
 <div class="form-group row">
             ...
             <div class="col-md-6">
                 <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('firstnam') }}" required autocomplete="firstnam">
         ...
         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('username') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" required autocomplete="lastname">
               ...
               <select id="country" name="country" class="form-control @error('email') is-invalid @enderror" name="country" value="{{ old('country') }}" required autocomplete="country">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                              <span>  <button type="submit" class="btn btn-success">
                                ...
                                <a style="float:right;" class="btn btn-link" href="{{ URL::route('resetpassword2') }}" >
 ...
 */
//echo '<br>'.md5("12121212");
//echo '<br>'.md5("P@ssw0rd");
?>
<?php
