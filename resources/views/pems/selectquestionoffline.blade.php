...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#addnewquestion">Add New Question</button>
...
@if($exam1 != 0)
	<div class="col-lg-6">
        ...
        <?php $exam = DB::table('exam')->where('examcode',$examcode)->first();
