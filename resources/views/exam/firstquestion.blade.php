...
<?php
$t =  $timeing * 60 ;  
    //echo "<br><br><br><br><br><br><br>time: is time as number :  ".$t;
/*
    |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
    || to submit if time out                                                                                                     |
    |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
*/
?> 
<div>
    <form  action="" method="post" name="mcQuestion" id="mcQuestion2">
<!--
    |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
<style>
    ...
    #radio{
        ...
        <script>  /*  to get data from input field */ /*
        document.getElementById("selected_q03").value;

        function getInputValue(){
            // Selecting the input element and get its value 
            var inputVal = document.getElementById("selected_q03").value;
...
*/
        ...
        <input hidden type="submit"   class="btn btn-danger">
        </form>
    </div>
...
<form action="selectthisquestion" method='POST' id="mcQuestion">
    @csrf
        ...
        <!--     </select>-->
        <select id="selected_q03" name="id0" class="btn btn-warning" style="font-size:14px !important;max-width:720px !important;color: #000000;" >        
        ...
        <input id="serial03" type="hidden" name="serial0" value="{{$serial}}" />
        <input id="attempno03" type="hidden" name="attempno" value="<?php echo $attempdata->attempno;  ?>" />
        <!--------- btn btn-outline-success select-button ---->
