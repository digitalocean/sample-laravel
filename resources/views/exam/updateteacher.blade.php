...
<div class="container">    
    ...
    <div class='col-lg-12'>
        ...
        <form action="updateteacher" method="post">
                ...
                <table class="table">
<tr><td>
                <lable>Teacher ID : </lable></td><td><input type="text" name="id" value="{{$teacher->id}}" placeholder="Insert Teacher Name"><br>
...
<tr><td>
        ...
        <tr><td>{{$teacher->id}}</td><td>{{$teacher->name}}</td><td>{{$teacher->comment}}</td><td><a href="/deleteteacher/{{$teacher->id}}" >Delete</a> Edit</td></tr>
        @endforeach
        </table>
            </div>
        </div>
