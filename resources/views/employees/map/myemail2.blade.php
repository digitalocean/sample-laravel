...
$id= Auth::user()->id;  ?>
            ...
            {!! Form::open(['action' => ['AddressController@updateemailaddress' ,$id], 'method' => 'POST' , 'enctype' => 'multipart/data']) !!}
             <div class="form-group">

             <div class="form-group">
             {{Form::label('email', 'Email')}}<br>
                {{Form::text('addressemail', Auth::user()->email, ['class' => 'from-control', 'required'=>'required'])}}
             </div>
