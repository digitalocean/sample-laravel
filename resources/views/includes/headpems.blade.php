...
nav {
  font-family: 'Eczar';font-size: 18px;}
  	.panel-heading{background-color:#DAA520 !important;color:white !important;padding:10px;}
    .panel-title{background-color:#DAA520;color:#fff;padding:0px;}
    .panel-body{border:1px solid #DAA520;padding:15px;}
    .col-lg-12{border:1px solid #DAA520;padding:15px;}
    ...
    button{background-color:#DAA520 !important;color:white !important;padding:10px;}
    .btn{background-color:#FFD700 !important;color:#191970 !important;padding:10px;}
    form{
  background-color:#B8860B;
  font-family: 'Eczar';font-size: 14px; 
