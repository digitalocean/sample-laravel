...
<div  class="col-lg-6">
  ...
  <form action="/address/data/{{$data->id}}" method="post">
		...
		<div class="form-group">
			...
			<input class="btn btn-success" type="submit" value="Change Delivery Address">

			<input class="btn btn-danger" type="submit" value="Confirm Address to EO">
		</div>
	<!--	</form>-->
...
<!--			<form method="POST" action="http://acpa-global.com/map/myaddresses" accept-charset="UTF-8"><input name="_token" type="hidden" value="ZM2mBbTtkKCPrMhboXs5un7EMZgchrhKepL6iPla">-->
		...
		<div class="form-group">
			<input class="btn btn-success" type="submit" value="Change Invoice Address">
			<input class="btn btn-danger" type="submit" value="Remove Invoice Address">
		</div>
	<!--	</form>-->
	...
	<!--<form method="POST" action="http://acpa-global.com/map/myaddresses" accept-charset="UTF-8"><input name="_token" type="hidden" value="ZM2mBbTtkKCPrMhboXs5un7EMZgchrhKepL6iPla">-->
		...
		<div class="form-group">
			<input class="btn btn-success" type="submit" value="Change Transcript Address">
			<input class="btn btn-danger" type="submit" value="Remove Transcript Address">
		</div>
	<!--	</form>-->
		</div><!-- pandel body -->
	</div>
