...
<div class="col-lg-6">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  <form method="POST" action="/coursesactivites/data/{{$data->id}}/edit/" accept-charset="UTF-8"><input name="_token" type="hidden" value="ZM2mBbTtkKCPrMhboXs5un7EMZgchrhKepL6iPla">
		    {{csrf_field()}}
            {{method_field('patch')}}
            <div class="form-group">
				<label for="courseid2">Member: </label>
				<input name="courseid" type="hidden" value="10313">
		    ...
		    <input class="btn btn-default" type="submit" value="Save to your CPD record">
