...
<body>
 ...
 <table><h1>
   <tr>
<td style="background-color:red;color:white;width:140;font-size:60px;">NBC<td><td style="background-color:white;color:red;font-size:30px;family-font:arial">Nazlawi Business College</td>
</tr>
</table>
...
<div class="panel-heading">Member Details Section</div>
			<div class="panel-body">
                <form action="/sendmail" method="POST" role="search">
					...
					<input name="email" type="text" value="ser@ss.ss">
