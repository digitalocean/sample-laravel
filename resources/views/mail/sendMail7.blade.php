...
-->
 <h3>Dear {{$user->name}} You are Pending Member with this data</h3>
 <h4>Pending Id   : {{$user->id}}</h4>
 <h4>Pending Pass : {{$user->password2}}</h4>
<p>I'm pleased to inform you that the first step of your registration with Nazalwi Business College was successful.</p>

<p>You now need to activate your account so that we can confirm that your email address is valid.</p>

To<p> activate your account please click the link button below:</p>
...
<p>Peter Halliwell, FQA</p>
<p>Nazalwi Business College Membership Director. </p>
    <!-- END Site header -->
    <!-- Main container -->
<br>
 
<a href="{{ url('completeregister/'.$id) }}" type="submit" value="" style="background-color:green;color:#FFF;heigh:20px; width:500px;font-size:25px;">
  <button style="background-color:green;color:#FFF;heigh:20px; width:500px;font-size:25px;">Click Here To complete your registeration</button></a>
			</div>
		</div>
    <br>
    <br>
