...
<div class="col-lg-6">
    ...
    <div class="form-group row">
        <label class="col-md-4 col-form-label text-md-right">Course Picture Upload </label><br>
...
<form enctype="multipart/form-data" method="POST" action="{!! route('coursePictureUpload2') !!}">
    @csrf

    <div class="form-group row">
        <label class="col-md-4 col-form-label text-md-right">Course PDF Upload </label><br>
...
<!--
   ...
   <thead>
    ...
    <th>ID</th>
        ...
        $pdf = DB::table('pdfcertificate')->where('user_id','=',$id)->get();
        ?>
...
@endforeach
 ...
 @foreach($pdf as $img)
<tr>
<td><p><a  href="{{asset('/public/img1/uploads/'.$img->courseimg)}}" heigh="200">Download {{$img->courseimg}}</a></p></td>
</tr>
@endforeach
</table>
