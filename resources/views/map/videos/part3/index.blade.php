  ...
  input{padding:5px;margin:5px;}
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                    ...
                    <a style="padding:15px;margin:15px" href="videos/part3/session1" class="btn btn-primary btn-lg btn-block">part3 Session 1<a> 
                    <a style="padding:15px;margin:15px" href="videos/part3/session2" class="btn btn-danger btn-lg btn-block">part3 Session 2</a>
                    <a style="padding:15px;margin:15px" href="videos/part3/session3" class="btn btn-warning btn-lg btn-block">part3 Session 3</a>
                    <a style="padding:15px;margin:15px" href="videos/part3/session4" class="btn btn-success btn-lg btn-block">part3 Session 4</a>
