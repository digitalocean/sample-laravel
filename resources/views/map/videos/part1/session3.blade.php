  ...
  input{padding:5px;margin:5px;}
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part1/0003/013.mp4')}}" type="video/mp4">
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part1/0003/014.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part1/0003/015.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part1/0003/016.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part1/0003/017.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
