  ...
  input{padding:5px;margin:5px;}
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/001.mp4')}}" type="video/mp4">
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/002.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/003.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/004.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/005.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/006.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
        ...
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/007.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                ...
                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/008.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
        ...
        <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                    <h3>Part Two</h3>
                    <strong>Session 1 :  Video -9 </strong></div>
                    <div class="panel-body">
                     

                <video width="100%" height="100%" controls>
                    <source src="{{URL::asset('/public/videos/part2/001/009.mp4')}}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                </div>
            </div>
