...
<?php       $ref_id = DB::table('ref_result')->max('id');
 ...
 <p>I'm pleased to inform you that we have applied the following Exemptions to your Exam ScoreCard:</p>
  ...
  <div style="float:right"><a href="http://127.0.0.1:8000/sendexamptepdf/{{$ref_id}}/{{$exam->examcode}}/{{$member->student_id}}"> Download PDF
 <img src="{{ asset('pdf1.png') }}" width ="150px" height="150px" alt="pdf" /> </a> 
