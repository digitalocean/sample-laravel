...
-->
    <title>@yield('PageTitle') - ACPA-Glopal </title>
    <!-- Styles --><!--
...
<link href="https://fonts.googleapis.com/css?family=Amaranth|Source+Sans+Pro" rel="stylesheet">
    ...
    <meta name="viewport" content="initial-scale = 1.0, maximum-scale = 1.0, user-scalable = no, width = device-width">
    <!-- Bootstrap Core CSS - ->
    <link href="127.0.0.1:8000css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS - ->
    <link href="127.0.0.1:8000css/modern-business.css" rel="stylesheet">

    <!-- Custom Fonts - ->
    <link href="127.0.0.1:8000font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<!-- Navigation -->
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container"> 
        <img src="../images/nbclogo.jpg" style="width:100px; height: 100px; float :left; margin:2px; margin-right:10px; margin-top:5px; margin-bottom: -15px;  "/>
...
<?php $student_id= Auth::user()->student_id;
...
You are Signed In as: 10313 seralkhatem Musa</h2>
	<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
