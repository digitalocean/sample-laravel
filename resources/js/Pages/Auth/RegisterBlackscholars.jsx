...
export default function Register({school}) {
        ...
        <div className="relative mt-1">
          <div className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
            <Combobox.Input
              ...
              displayValue={(school) => school.schoolName}
              onChange={(event) => setQuery(event.target.value) && setData('school', e.target.value)}
            />
          ...
          <Transition
            ...
            afterLeave={() => setQuery('')}
          >
            <Combobox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base ring-1 ring-black/2 focus:outline-none sm:text-sm">
              {filteredSchool.length === 0 && query !== '' ? (
                      ...
                      <>
                        <span
                          className={`block truncate ${
                            selectedSchool ? 'font-medium' : 'font-normal'
                          }`}
                        >
                          {school.schoolName}
                        </span>
