...
const uses = [
  ...
  { id: 2, value: '2x per year', label: '2x per year' },
  { id: 3, value: 'one-time', label: 'one-time' },
]
...
export default function freqSelection({selectedFrequnecy, setSelectedFrequnecy}) {
