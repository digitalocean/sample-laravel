...
export default function CreateWinner() {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    router.post(route('scholarship.create'), [data, selectedFrequnecy]);
  }
                          ...
                          <div className="border-b border-gray-900/10 pb-8">
                            ...
                            <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                              ...
                              <div className="sm:col-span-3">
                                <label htmlFor="award_amount" className="block text-sm text-left font-medium leading-6 text-gray-900">
                                  Award Amount
                                </label>
                                <div className="mt-2">
                                  <input
