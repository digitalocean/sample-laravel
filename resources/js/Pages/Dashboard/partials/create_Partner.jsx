...
import { CheckIcon, ArrowSmallRightIcon  } from '@heroicons/react/24/outline';
...
export default function CreatePartner() {
  ...
  return (
    <>
        <button className="mt-auto mb-0 font-semibold leading-normal text-sm group text-slate-500 text-left" onClick={openModal}>
            Create a new partner of success
