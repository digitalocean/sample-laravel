...
export default function Guest({ children }) {
    return (
        <div className="min-h-screen flex flex-col sm:justify-center items-center sm:pt-0 bg-white">
             <nav className="absolute bg-black/60 rounded-2xl top-0 z-30 flex flex-wrap items-center justify-between w-2/3 px-4 py-2 mt-10 mb-4 shadow-none lg:flex-nowrap lg:justify-start">
