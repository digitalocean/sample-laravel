    ...
    'connections' => [
        ...
        */
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'db-mysql-nyc1-98391-do-user-9288315-0.b.db.ondigitalocean.com'),
            'port' => env('DB_PORT', '25060'),
            'database' => env('DB_DATABASE', 'defaultdb'),
            'username' => env('DB_USERNAME', 'doRemoto'),
            'password' => env('DB_PASSWORD', 'z0z84krg2s54tdpz'),
